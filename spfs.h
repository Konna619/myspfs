...
extern int spfs_getattr_bp(struct user_namespace * ns, const struct path *, struct kstat *, u32,
		unsigned int);
extern int spfs_setattr_bp(struct user_namespace * ns, struct dentry *, struct iattr *);
extern int spfs_permission_bp(struct user_namespace * ns, struct inode *, int);
extern int spfs_rmdir_bp(struct inode *, struct dentry *);
extern int spfs_mkdir_bp(struct user_namespace * ns, struct inode *, struct dentry *, umode_t);
extern int spfs_create_bp(struct user_namespace * ns, struct inode *, struct dentry *, umode_t, bool);
